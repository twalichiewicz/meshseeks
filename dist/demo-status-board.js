...
class StatusBoardDemo {
    ...
    async simulateComplexProjectAnalysis() {
        ...
        const analysisAgents = [
            { id: 'agent-auth-001', role: 'analysis' },
            { id: 'agent-api-002', role: 'analysis' },
            { id: 'agent-db-003', role: 'analysis' },
            { id: 'agent-sec-004', role: 'debugging' }
        ];
        ...
        const implAgents = [
            { id: 'agent-impl-001', role: 'implementation' },
            { id: 'agent-impl-002', role: 'implementation' },
            { id: 'agent-impl-003', role: 'implementation' },
            { id: 'agent-impl-004', role: 'implementation' }
        ];
        ...
        const testAgents = [
            { id: 'agent-test-001', role: 'testing' },
            { id: 'agent-test-002', role: 'testing' },
            { id: 'agent-test-003', role: 'testing' }
        ];
        ...
        const docAgent = { id: 'agent-doc-001', role: 'documentation' };
    ...
    async simulateTaskWithProgress(task, agentId) {
