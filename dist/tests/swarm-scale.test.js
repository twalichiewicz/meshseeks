 ...
 * @version 1.0.0
 */
import { HierarchicalPlanner } from '../swarm/hierarchical-planner.js';
import { JudgeSystem } from '../swarm/judge-system.js';
...
class SwarmScaleTestSuite {
    ...
    createTestTask(id, depth = 0, parentId = null, role = 'implementation') {
        return {
            id,
            parentId,
            depth,
    ...
    async testHierarchicalPlanner() {
      ...
      `;
            ...
            const result = await planner.decompose(rootTask, context);
